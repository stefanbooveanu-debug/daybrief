...
void main() {
  ...
  group('DateUtils formatters', () {
    test('formatTime → 12h h:mm a', () {
      ...
      expect(DateUtils.formatTime(DateTime(2026, 5, 25)), '12:00 AM');
      expect(DateUtils.formatTime(DateTime(2026, 5, 25, 12)), '12:00 PM');
    });
    ...
    test('formatTime24 → 24h HH:mm', () {
      ...
      expect(DateUtils.formatTime24(DateTime(2026, 5, 25)), '00:00');
    });
    ...
    test('formatMonthName → MMMM', () {
      ...
      expect(DateUtils.formatMonthName(DateTime(2026, 12)), 'December');
    });
  });
