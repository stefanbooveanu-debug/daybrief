        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                ..._options.asMap().entries.map((entry) =>
                    _buildTimeOption(entry.value, entry.key, isDark)),
              ],
            ),
          ),
          ...
          if (_options.any((o) => (o['votes'] as int) > 0)) ...[
            ...
            ..._options.asMap().entries.map(
                (entry) => _buildResultBar(entry.value, entry.key, isDark)),
          ],
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(DateFormat('EEE h:mm a').format(option['time']),
                  style: TextStyle(
                      fontWeight: FontWeight.w600,
                      color: isDark ? Colors.white : const Color(0xFF202124))),
          ...
          FilledButton(
            onPressed: () {
              if (_nameController.text.trim().isNotEmpty) {
                setState(() {
                  _options[index]['votes'] =
                      (_options[index]['votes'] as int) + 1;
                  (_options[index]['voters'] as List)
