  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isToday ? const Color(0xFFE8F0FE) : Colors.transparent,
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              color: isToday ? const Color(0xFF1A73E8) : const Color(0xFF5F6368),
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                  color: isToday ? Colors.white : const Color(0xFF202124),
                                ),
                              ),
                            ),
                          ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => _showAddEventForDate(DateTime.now()),
