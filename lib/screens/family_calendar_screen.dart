...
class _FamilyCalendarScreenState extends State<FamilyCalendarScreen> {
  ...
  final List<Event> _familyEvents = [
    Event(
        ...
        description: 'Grandma coming over',
    ...
    Event(
        ...
        description: 'Sunday morning golf',
        category: EventCategory.personal,
        userId: 'dad'),
  ];
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: member['color'], width: 3),
                            ),
                            child: Center(
  ...
  Widget _buildFamilyEventCard(Event event, bool isDark) {
    final member = _familyMembers.firstWhere(
      (m) =>
          ...
          _getMemberName(event.userId).toLowerCase(),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: member['color'].withValues(alpha: 0.3), width: 2),
      ),
      child: Row(
        children: [
          Container(
  ...
  String _getMemberName(String userId) {
    final member = _familyMembers
        .where(
            (m) => m['name'].toString().toLowerCase() == userId.toLowerCase())
        .firstOrNull;
